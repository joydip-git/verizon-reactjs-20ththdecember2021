...
export default class ProductUpdate extends PureComponent {
    ...
    //     console.log('SCU', newState)
    //     console.log(this.state)
    //     if (newProps.selectedId === this.props.selectedId && this.state.productInfo && newState.productInfo.productId === this.state.productInfo.productId)
    //         return false
